...
const ScoreboardDisplay = ({ scoreboardData }) => {
  ...
  return (
    <div className="font-roboto mx-auto p-5 text-center bg-gray-300 h-[88dvh]">
    ...
    <div className="flex flex-wrap p-4 h-auto lg:max-h-[95%] justify-center gap-2 mt-6 overflow-auto">
      {scoreboardData.scoreboard.games.map((game) => (
        <div
          className="flex flex-col h-full lg:h-[140px] w-full lg:w-5/12 bg-gray-800 p-6 rounded-lg shadow-lg transition duration-200 ease-in-out hover:scale-105 hover:shadow-xl mb-4 flex-shrink-0"
          key={game.gameId}
        >
